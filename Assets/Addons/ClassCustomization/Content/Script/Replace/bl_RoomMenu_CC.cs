...
public class bl_RoomMenu_CC : bl_PhotonHelper
{
    [HideInInspector]
    ...
    protected override void Awake()
    {
        ...
        GetPrefabs();
        //NOTE: the gameobject with the script "bl_SaveInfo" need have the name "PlayerInfo"
        //for this work correct
    ...
    void OnGUI()
    {
        ...
        GUI.color = Color.white;
        GUI.Label(new Rect(5, Screen.height - 140, 100, 35), "Class: " + m_playerclass.ToString());
    ...
    void SelectClassMenu()
    {
        ...
        if (GUILayout.Button("Assault", GUILayout.Width(100), GUILayout.Height(50)))
        {
            ...
            {
                bl_ClassManager.m_Class = PlayerClass.Assault;
            }
            else
            {
                m_playerclass = PlayerClass.Assault;
        ...
        if (GUILayout.Button("Recon", GUILayout.Width(100), GUILayout.Height(50)))
        {
            if (GameObject.Find(bl_ClassManager.ClassManagerName) != null)
            {
                bl_ClassManager.m_Class = PlayerClass.Recon;
            }
            else
            {
                m_playerclass = PlayerClass.Recon;
        ...
        if (GUILayout.Button("Suport", GUILayout.Width(100), GUILayout.Height(50)))
        {
            if (GameObject.Find(bl_ClassManager.ClassManagerName) != null)
            {
                bl_ClassManager.m_Class = PlayerClass.Support;
            }
            else
            {
                m_playerclass = PlayerClass.Support;
        ...
        if (GUILayout.Button("Engineer", GUILayout.Width(100), GUILayout.Height(50)))
        {
            if (GameObject.Find(bl_ClassManager.ClassManagerName) != null)
            {
                bl_ClassManager.m_Class = PlayerClass.Engineer;
            }
            else
            {
                m_playerclass = PlayerClass.Engineer;
    ...
    public override void OnLeftRoom()
    {
        ...
        {
            Debug.LogError("PlayerInfo is not found, info is not save");
        }
        // back to main menu        
