...
public class bl_PlayerAnimations : MonoBehaviour
{
    ...
    {
        SetupSegments();
        m_Animations.anim[m_Animations.walkForward].speed = 1.3f;
        ...
        m_Animations.anim[m_Animations.walkBackwards].speed = 1.3f;
        m_Animations.anim[m_Animations.strafeLeft].speed = 1.3f;
        m_Animations.anim[m_Animations.strafeRight].speed = 1.3f;

        m_Animations.anim[m_Animations.runForward].layer = 1;
        m_Animations.anim[m_Animations.runForward].speed = 1.2f;
    ...
    void Animate()
    {
        if (grounded)
        {
            ...
            if (movementSpeed < 1.0f)
            {
                ...
                {
                    m_Animations.anim.Blend(turnAnim, 0.6f);
                    return;
                }
            }
            ...
            { //Walk and Run
                ...
                { //Forward
                    ...
                    {
                        m_Animations.anim.CrossFade(m_Animations.walkForward, 0.2f);
                    }
                    else
                    {
                ...
                else if (localVelocity.x < -1.0f)
                {
                    ...
                    if (movementSpeed < 5.0f)
                    {
                        m_Animations.anim.CrossFade(m_Animations.strafeLeft, 0.5f);
                    }
                ...
                else if (localVelocity.x > 1.0f)
                {
                    ...
                    if (movementSpeed < 5.0f)
                    {
                        m_Animations.anim.CrossFade(m_Animations.strafeRight, 0.5f);
                    }
                }
                else
                {
            ...
            { //Crouch
                ...
                {
                    m_Animations.anim.CrossFade(m_Animations.crouchWalkForward, 0.5f);
                }
                else if (localVelocity.z < -0.2f)
                {
                    m_Animations.anim.CrossFade(m_Animations.crouchWalkBackwards, 0.4f);

                }
                else if (localVelocity.x < -0.2f)
                {
                    m_Animations.anim.CrossFade(m_Animations.crouchWalkLeft, 0.5f);

                }
                else if (localVelocity.x > 0.2f)
                {
                    m_Animations.anim.CrossFade(m_Animations.crouchWalkRight, 0.5f);
                }
                else
                {
        ...
        else
        {
            ...
            m_Animations.anim[m_Animations.standingJump].normalizedTime = normalizedTime;
            m_Animations.anim.CrossFade(m_Animations.standingJump, 0.1f);
            m_Animations.anim[m_Animations.runJump].normalizedTime = normalizedTime;
            m_Animations.anim.CrossFade(m_Animations.runJump, 0.1f);
